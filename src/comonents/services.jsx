...
import { Briefcase, Target, MessageSquare, Gavel, Ship, Lightbulb, Check } from 'lucide-react';
...
const Services = () => {
  const serviceData = [
    {
      icon: { component: <Target className="w-6 h-6 text-blue-600" />, bgColor: 'bg-blue-100' },
    ...
    {
      icon: { component: <MessageSquare className="w-6 h-6 text-teal-600" />, bgColor: 'bg-teal-100' },
    ...
    {
      icon: { component: <Gavel className="w-6 h-6 text-indigo-600" />, bgColor: 'bg-indigo-100' },
      title: "Legal Affairs",
    ...
    {
      icon: { component: <Ship className="w-6 h-6 text-amber-600" />, bgColor: 'bg-amber-100' },
          ...
          <div className="service-card">
            <div className="flex flex-col md:flex-row md:items-center">
              <div className="flex-shrink-0 w-24 h-24 bg-rose-100 rounded-full flex items-center justify-center mr-0 mb-4 md:mr-6 md:mb-0">
                <Lightbulb className="w-12 h-12 text-rose-600" />
              </div>
              <div>
                ...
                <ul className="space-y-2 text-gray-600 sm:flex sm:space-y-0 sm:space-x-6">
                  <li className="flex items-start"><Check className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-1" /><span>Access to up-to-date expertise.</span></li>
                  <li className="flex items-start"><Check className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-1" /><span>Improved product quality.</span></li>
                  <li className="flex items-start"><Check className="w-5 h-5 mr-2 text-green-500 flex-shrink-0 mt-1" /><span>Reduced compliance risks.</span></li>
                </ul>
              </div>
            </div>
          </div>
